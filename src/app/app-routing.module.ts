...
@NgModule({
    imports: [
        RouterModule.forRoot([
            ...
            { path: 'investigacion-publicaciones-may-oct-2024', loadComponent: () => import('./modules/investigacion/investigacion-publicaciones-may-oct-2024/inv-pubs-may-oct24').then(m => m.InvestigacionPublicacionesMayOct2024Component) },
            { path: 'investigacion-publicaciones-nov2023-abr2024', loadComponent: () => import('./modules/investigacion/investigacion-publicaciones-nov2023-abr2024/inv-pubs-nov23-abr24.component').then(m => m.InvestigacionPublicacionesNov2023Abr2024Component) },
            { path: 'investigacion-publicaciones-may-oct-2023', loadComponent: () => import('./modules/investigacion/investigacion-publicaciones-may-oct-2023/inv-pubs-may-oct23').then(m => m.InvestigacionPublicacionesMayOct2023Component) },
            { path: 'investigacion-publicaciones-nov2022-abr2023', loadComponent: () => import('./modules/investigacion/investigacion-publicaciones-nov2022-abr2023/inv-pubs-nov22-abr23.component').then(m => m.InvestigacionPublicacionesNov2022Abr2023Component) },
